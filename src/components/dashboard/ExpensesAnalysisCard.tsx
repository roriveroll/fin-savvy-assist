        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 h-48 relative">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={expenses} cx="50%" cy="50%" labelLine={false} outerRadius={80} innerRadius={40} fill="#8884d8" dataKey="value">
          ...
          <div className="w-full md:w-1/2 space-y-3 mt-4 md:mt-0">
            {expenses.map((expense, index) => <div key={index} className="flex items-center justify-between">
